...
int main(int argc, char **argv)
{
	...
	char settings[]="/home/e4e/workspace/multicam_orbslam/multicam_orbslam/MultiCol-SLAM/Examples/cam_sidebyside.yaml";
	char calib[]="/home/e4e/workspace/multicam_orbslam/multicam_orbslam/MultiCol-SLAM/Examples/";	
    //if(argc != 3)
    //{
