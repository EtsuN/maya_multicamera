...
std::string CameraGroupSubscriber::sImageTopic = "rgb/image_raw"; //add color/ if using realsense, same for the next line
std::string CameraGroupSubscriber::sInfoTopic = "rgb/camera_info";
